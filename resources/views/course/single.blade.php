        ...
        <div class="container">
                ...
                <ol role="list" class="flex items-center space-x-0.5">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="-m-1">
                                <a href="{{route('course-single', $couresSingle->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">{{$couresSingle->name}} </a>
                            </div>
                        </div>
                    </li>
                </ol>
            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    <div class="flex">
                        <h1 class="text-3xl font-bold text-gray-900">{{$couresSingle->name}}</h1>
                    </div>
                    ...
                    <ul class="flex flex-wrap items-center gap-4 mt-5 text-gray-700">
                        <li class="flex items-center gap-2">
                            ...
                            <span>{{$couresSingle->durationFun($couresSingle->duration)}}</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <svg class="w-6 h-6 text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"></path>
                            </svg>
                            <span>{{$couresSingle->userlevel($couresSingle->level)}}</span>
                        </li>
                        <li class="flex items-center gap-2">
                            ...
                            <span>{{$couresSingle->price == 0 ? 'free' : number_format($couresSingle->price, 2)}}</span>
                        </li>
                    </ul>
                    <div class="rounded-sm mt-8 shadow-sm bg-white">
                        <img  class="w-[1200px] h-[300px]" src="{{$couresSingle->image}}" alt="Testing Laravel">
                        <div class="p-6">
                            <div class="text-base space-y-6 font-normal text-gray-700 line-clamp-20">
                                {{$couresSingle->description}}
                            </div>
                ...
                <div class="w-1/3 pl-10 pt-0">
                    <div class="mt-2 mb-4 space-y-3">
                        <a href="#" target="_blank" class="flex items-center justify-center w-full px-4 py-3 text-base font-bold text-center text-white transition-all duration-200 bg-red-500 border-2 border-transparent rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-white hover:text-black hover:border-b-2 hover:border-red-500"> Get the
                            {{$couresSingle->type == 0 ? 'Book' : 'video' }} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-4 pb-2">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover w-48 m-auto shadow" src="https://laravel-courses.com/storage/thumbnails/default/9d/ke/1lin0xkwk00s888k8wc48.png?p=authors%2F04ff15e2-69b1-4110-a7a8-0ec15616abaf.png&amp;s=pd&amp;widen=200" alt="Freek Van der Herten Profile Picture">
                                </div>
                                ...
                                <div class="text-sm px-7">
                                    <p class="text-gray-500">I'm a PHP developer and Laravel enthusiast. Most of my time is spent at Spatie of which I'm the co-owner. Whenever my colleagues and I stumble upon a problem that we can solve in a clean way, we extract our solution so other developers can use it. Together with my colleagues I regularly release packages that have been downloaded more than 500 million times.</p>
                                </div>
                            </div>
                    ...
                    <div class="overflow-hidden bg-white border border-gray-200 rounded-sm mt-6 shadow-sm">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="mt-8 flex flex-wrap gap-2.5">
                                @foreach($couresSingle->topics as $topics)
                                <a href="{{route('topics', $topics->slug)}}" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-1.5 hover:bg-gray-100">
                                    ...
                                    <div class="ml-3.5 text-sm font-medium text-gray-900">{{$topics->name}}</div>
                                </a>
                                @endforeach
                            </div>
                        </div>
